...
def register_new_video_game():
    ...
    with open('6_File_Usage/1_CSV_usage_exercise/video_games.csv', 'a', encoding='utf-8', newline='') as file:
...
def print_video_games():
    try:
        with open('6_File_Usage/1_CSV_usage_exercise/video_games.csv', 'r', encoding='utf-8') as file:
